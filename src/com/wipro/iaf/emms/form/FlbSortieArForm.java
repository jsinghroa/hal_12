...
public class FlbSortieArForm {
	...
	public String toString() {
		return "FlbSortieArForm [sortieNo=" + sortieNo + ", sortieDate="
				+ sortieDate + ", ETD=" + ETD + ", etdDate=" + etdDate
				+ ", duration=" + duration + ", flightType=" + flightType
				+ ", sortieStatus=" + sortieStatus + ", statusDate="
				+ statusDate + ", changedBy=" + changedBy + ", remarks="
				+ remarks + ", reason=" + reason + ", accept=" + accept
				+ ", reject=" + reject + ", error=" + error + ", errordesc="
				+ errordesc + ", recordId=" + recordId + ", flbNum=" + flbNum
