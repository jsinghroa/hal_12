...
public class MeterDetailsForm {
	...
	public String toString() {
		return "MeterDetailsForm [installedPN=" + installedPN
				+ ", installedPartDescription=" + installedPartDescription
				+ ", installedSN=" + installedSN + ", meterName=" + meterName
				+ ", installationDate=" + installationDate
				+ ", installationCount=" + installationCount
				+ ", currentCount=" + currentCount + ", ExAstCurrentCount="
				+ ExAstCurrentCount + ", ExAstInstallCount="
				+ ExAstInstallCount + ", ExAstInstallCountHMS="
				+ ExAstInstallCountHMS + ", ExAstCurrentCount_HMS="
				+ ExAstCurrentCount_HMS + ", uom=" + uom
				+ ", existingInstalledPn=" + existingInstalledPn
				+ ", existingInstalledSN=" + existingInstalledSN + ", error="
				+ error + ", errorDescription=" + errorDescription
				+ ", recordRowId=" + recordRowId
				+ ", getExistingInstalledSN()=" + getExistingInstalledSN()
				+ ", getExistingInstalledPn()=" + getExistingInstalledPn()
				+ ", getUom()=" + getUom() + ", getInstallationCount()="
				+ getInstallationCount() + ", getCurrentCount()="
				+ getCurrentCount() + ", getExAstCurrentCount()="
				+ getExAstCurrentCount() + ", getExAstInstallCount()="
				+ getExAstInstallCount() + ", getExAstInstallCountHMS()="
				+ getExAstInstallCountHMS() + ", getExAstCurrentCount_HMS()="
				+ getExAstCurrentCount_HMS() + ", getRecordRowId()="
				+ getRecordRowId() + ", getInstalledPN()=" + getInstalledPN()
				+ ", getInstalledPartDescription()="
				+ getInstalledPartDescription() + ", getInstalledSN()="
				+ getInstalledSN() + ", getMeterName()=" + getMeterName()
				+ ", getInstallationDate()=" + getInstallationDate()
				+ ", getError()=" + getError() + ", getErrorDescription()="
				+ getErrorDescription() + ", getClass()=" + getClass()
